...
const IllustrationAct = () => {
  ...
  const [activity] = useState({
    ...
    type: 'Image',
    description:
      'Representa de manera gráfica el siguiente concepto:',
    concept: 'Alegria',
    instruction:
      'Cree y suba una ilustración.',
  });
          ...
          <Card>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <Card.Image
                ...
                source={require('../../../assets/images/activities/illustration.jpg')}
              />
              <View style={styles.activityContent}>
                ...
                <Card.Image
                  ...
                  source={require('../../../assets/images/activities/illustration/alegria.jpg')}
                />
