  ...
  return (
    <View>
      <Modal
        ...
        <View style={stylesVideo.centeredView}>
          <View style={stylesVideo.modalView}>
            <Text style={stylesVideo.modalTextTitle}>Revisa tu trabajo aqui</Text>
            {/* {activity.type === 'Link' ? ( */}
            <Thumbnail
              type={'standard'}
              imageWidth="100%"
            ...
            />
            {/* ) : null} */}
            <Pressable style={[stylesVideo.modalButton, stylesVideo.submitButton]}>
      ...
      <View style={stylesVideo.containerSubmit}>
        <TextInput onChangeText={setUrl} style={stylesVideo.inputStyle} keyboardType={'url'} placeholder={'Copia tu link aqui'} />
        <Button
          icon={
            <Icon
              name="upload"
...
const SubmitComponent = ({ typeSubmit }) => {
  return (
    <View>
